			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<h2>Online Shopping Web App Cart</h2>
						<p>Check your cart here</p>
					</div>
					<div class="col-md-12">
				...
				$total = 0;
				 ...
				 ?>
					<tr>
						...
						<td>
							<span class="amount">ZAR<?php echo $cartr['price']; ?>.00/-</span>
						</td>
						<td>
							<div class="quantity"><?php echo $value['quantity']; ?></div>
						</td>
						<td>
							<span class="amount">ZAR<?php echo ($cartr['price']*$value['quantity']); ?>.00/-</span>
						</td>
					</tr>
				<?php
				...
				<div class="col-md-6 push-md-6 no-padding">
					...
					<table class="table table-bordered col-md-6">
						<tbody>
							<tr>
								<th>Cart Subtotal</th>
								<td><span class="amount">ZAR <?php echo $total; ?>.00/-</span></td>
							</tr>
							<tr>
							...
							<tr>
								<th>Order Total</th>
								<td><strong><span class="amount">ZAR <?php echo $total; ?>.00/-</span></strong> </td>
							</tr>
						</tbody>
					</table>
				</div>
