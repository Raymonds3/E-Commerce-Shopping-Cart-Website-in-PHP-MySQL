	...
	<section id="content">
		<div class="content-blog">
					<div class="page_header text-center">
						<h2>ONLINE SHOPPING WEB APP - Checkout</h2>
						<p>Get the best Checkout Experience</p>
					</div>
<form method="post">
<div class="container">
			<div class="row">
			...
			<table class="table table-bordered extra-padding">
				<tbody>
					<tr>
						<th>Cart Subtotal</th>
						<td><span class="amount">ZAR <?php echo $total; ?></span></td>
					</tr>
					<tr>
					...
					<tr>
						<th>Order Total</th>
						<td><strong><span class="amount">ZAR <?php echo $total; ?></span></strong> </td>
					</tr>
				</tbody>
			</table>
