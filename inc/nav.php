			<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="http://localhost:81/ecomphp/index.php">Home</a>
					</li>
					<li>
						<a href="#">Shop</a>
					...
					<li>
						...
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://localhost:81/ecomphp/my-account.php">My Orders</a></li>
							<li><a href="http://localhost:81/ecomphp/edit-address.php">Update Address</a></li>
							<li><a href="http://localhost:81/ecomphp/logout.php">Logout</a></li>
						</ul>
					</li>
					<li>
						<a href="#">Contact</a>
				...
				<?php $cart = isset($_SESSION['cart']) ? $_SESSION['cart'] : array(); ?>
					<div class="s-cart">
						...
						<div class="cart-info">
							...
							<div class="ci-item">
								...
								<div class="ci-item-info">
									...
									<p><?php echo $value['quantity']; ?> x ZAR <?php echo $navcartr['price']; ?>.00/-</p>
									<div class="ci-edit">
							...
							<div class="ci-total">Subtotal: ZAR <?php echo $total; ?>.00/-</div>
							<div class="cart-btn">
